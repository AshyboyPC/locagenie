...
const LiquidButton = () => {
  ...
  return (
    <div className="flex justify-center">
      <a
        href="#contact"
        className="relative inline-block w-64 h-[3.5em] mx-auto group dark:bg-black bg-white dark:border-white border-black border-2 rounded-lg">
        ...
        <button
          ...
          <span className="flex items-center justify-center px-4 gap-3 rounded-lg group-hover:text-yellow-400 text-white text-lg font-semibold tracking-wide whitespace-nowrap">
            <Calendar className="group-hover:fill-yellow-400 fill-white w-5 h-5 flex-shrink-0" />
