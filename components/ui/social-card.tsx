...
const SocialCard = ({
  title = "Follow Us",
  socialLinks = [
    { href: "https://instagram.com/locagenie", icon: <InstagramIcon />, className: "box1" },
    { href: "https://twitter.com/locagenie", icon: <TwitterIcon />, className: "box2", delay: "0.2s" },
    { href: "https://discord.gg/locagenie", icon: <DiscordIcon />, className: "box3", delay: "0.4s" },
  ],
}: SocialCardProps) => (
  <div className="card">
